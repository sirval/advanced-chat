...
//Import Images
import default_avatar from "../../../assets/images/users/default_avatar.jpeg";
            ...
            <div>
                ...
                <div className="text-center border-bottom p-4">
                    <div className="mb-4 profile-user">
                        <img src={user?.data?.user?.profile_photo ?? default_avatar} className="rounded-circle avatar-lg img-thumbnail" alt={user?.data?.user?.name} />
                    ...
                    <h5 className="font-size-16 mb-1 text-truncate">{user?.data?.user?.name}</h5>
                        ...
                        <Card className="shadow-none border mb-2">
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <h5 className="font-size-14">{user?.data?.user?.name}</h5>
                                </div>

                                <div className="mt-4">
                                    <p className="text-muted mb-1">{t('Email')}</p>
                                    <h5 className="font-size-14">{user?.data?.user?.email}</h5>
                                </div>
