                        ...
                        <Modal isOpen={this.state.modal} centered toggle={this.toggle}>
                            ...
                            <ModalBody className="p-4">
                                <Form>
                                    ...
                                    <div>
                                        <Label className="form-label" htmlFor="addcontact-invitemessage-input">{t('Contact could be comma separated lists of email or phone numbers (with country code)')}</Label>
                                        <textarea className="form-control" id="addcontact-invitemessage-input" rows="3" placeholder="Enter contact(s) e.g example.com, johndoe@mail.com, +234000000000 "></textarea>
                                    </div>
                                </Form>
                            </ModalBody>
                            <ModalFooter>
